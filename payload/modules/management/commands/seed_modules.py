...
MODULES = [
    ...
    dict(key="transportation", name="Transportation", description="Maps, travel guidance and future bus API integration.", system_enabled=False, visible_to_weddings=False, sort_order=230),
    dict(key="budgeting", name="Budgeting", description="Couple budget, estimates, actual spending and financial summary.", system_enabled=False, visible_to_weddings=False, sort_order=240, allowed_roles=["WEDDING_OWNER", "WEDDING_MANAGER", "WEDDING_PLANNER"]),
    dict(key="planner", name="Wedding Planner", description="Planner tasks, timeline, vendors and run sheet.", system_enabled=False, visible_to_weddings=False, sort_order=250, allowed_roles=["WEDDING_OWNER", "WEDDING_MANAGER", "WEDDING_PLANNER"]),
    ...
    dict(key="onedrive", name="OneDrive Storage", description="Microsoft Graph storage integration.", system_enabled=False, visible_to_weddings=False, sort_order=270),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        current_keys = {"accounts", "weddings", "guests", "invitations", "staffing", "rsvp", "gifts", "checkins", "return_gifts", "photos", "invitation_themes"}
